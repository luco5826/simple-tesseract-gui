#############################################################################
# Makefile for building: tesseract
# Generated by qmake (3.1) (Qt 5.11.3)
# Project:  tesseract.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile tesseract.pro
#############################################################################
...
INCPATH       = -I. -I. -isystem /usr/include/x86_64-linux-gnu/qt5 -isystem /usr/include/x86_64-linux-gnu/qt5/QtWidgets -isystem /usr/include/x86_64-linux-gnu/qt5/QtGui -isystem /usr/include/x86_64-linux-gnu/qt5/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/usr/include/leptonica
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = tesseract1.0.0
DISTDIR = /home/luca/Modelli/tesseract/.tmp/tesseract1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread -ltesseract -llept
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: tesseract.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile tesseract.pro
